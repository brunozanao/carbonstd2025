    ...
    <section id="investor">
      ...
      <div className="container">
        ...
        <div className="neoh_fn_title">
          <h3 className="fn_title">Our Partnerships</h3>
          <div className="line">
            <span />
          </div>
        </div>
        ...
        <div className="neoh_fn_investor">
          <ul>
            ...
            <li>
              <div className="item">
                <img src="img/investors/12.png" alt="" />
                <a href="#" className="full_link" />
              </div>
            </li>
            <li>
              <div className="item">
                <img src="img/investors/13.png" alt="" />
                <a href="#" className="full_link" />
              </div>
            </li>
            <li>
              <div className="item">
                <img src="img/investors/14.png" alt="" />
                <a href="#" className="full_link" />
              </div>
            </li>
            <li>
              <div className="item">
                <img src="img/investors/15.png" alt="" />
                <a href="#" className="full_link" />
              </div>
            </li>
          </ul>
